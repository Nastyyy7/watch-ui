            ...
            <div className={styles.conteiner}>
                ...
                <div className={styles.card}>
                    ...
                    <div className={styles.card_block}>
                        <h3 className={styles.card_block_title}>Наручные часы LEVEL</h3>
                        <p className={styles.card_block_article}>Артикул: <span>7001410</span></p>
                        <p className={styles.card_block_price}>2500<span>руб</span></p>
