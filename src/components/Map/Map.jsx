        ...
        <section>
            <div className={styles.conteiner}>
                <div style={{position:'relative',overflow:'hidden', borderRadius:'40px', marginTop:'40px'}}>
                    <Link href="https://yandex.ru/maps/org/remont_chasov/1109593602/?utm_medium=mapframe&utm_source=maps" style={{color:'#eee',fontSize:'12px',position:'absolute',top:'0px',}}>Ремонт часов</Link>
                    <Link href="https://yandex.ru/maps/213/moscow/category/clock_and_watch_repair/184108239/?utm_medium=mapframe&utm_source=maps" style={{color:'#eee',fontSize:'12px',position:'absolute',top:'14px',}}>Ремонт часов в Москве</Link>
                    <Link href="https://yandex.ru/maps/213/moscow/category/watch_shop/184107945/?utm_medium=mapframe&utm_source=maps" style={{color:'#eee',fontSize:'12px',position:'absolute',top:'28px',}}>Магазин часов в Москве</Link>
